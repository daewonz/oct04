            ...
            if (selectedDate === today.toISOString().split("T")[0]) {
               ...
               if (attendance != undefined) {
                  ...
                  btnIn.on('click', function() {
                     ...
                     currentHour = parseInt(serverDate.toString().substring(16, 18));
                      currentMinute = parseInt(serverDate.toString().substring(19, 23));
                     
                      if (currentHour <= 9 && currentHour >= 18) {
                          atmgsts = 0; // 정상출근
                      } else if ((currentHour < 18 && currentHour > 9) || (currentHour === 9 && currentMinute > 0)) {
                          atmgsts = 1; // 지각
                      } else if (currentHour < 9 || currentHour > 18 || (currentHour >= 18 && currentMinute > 0)) {
                          atmgsts = 3; // 결근
                      } else {
                          atmgsts = 2; // 조퇴
                      }
